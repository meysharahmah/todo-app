<nav class="navbar">
    ...
    <img src="images/background.jpg" alt="Header Background"
        style="position: absolute; 
           ...
           z-index: -1;">
    <!-- Menggunakan z-index agar background berada di belakang konten lainnya -->

    <div class="container-fluid d-flex flex-column align-items-center justify-content-center text-white"
        style="height: 250px;">
        <!-- Gambar Profil -->
        <img src="{{ asset('images/profileweb.jpg') }}" alt="Profile Picture"
...
<nav class="navbar navbar-expand-lg bg-success navbar-dark px-3">
    <div class="container-fluid">
        ...
        <a class="navbar-brand fw-bolder d-flex align-items-center gap-2" href="#">
            <i class="bi bi-card-checklist text-white"></i> <!-- Ikon Bootstrap -->
